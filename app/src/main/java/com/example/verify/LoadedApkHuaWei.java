    ...
    private static class V28VerifierImpl extends V26VerifierImpl {
        ...
        private static class AmsInvocationHandler implements InvocationHandler {
            ...
            public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                ...
                if (TextUtils.equals(REGISTER_RECEIVER, methodName)) {
                ...
                } else if(TextUtils.equals("bindService", methodName)){
                    Intent intent = (Intent) args[2];
                    Object obj = args[4];
                    ComponentName componentName = intent.getComponent();
                    System.out.println("methodName=  bindService" + componentName.toString() + " objStr=" + obj.toString() + " hashCode=" + obj.hashCode() +  "  pid= " + Process.myPid());//ComponentInfo{com.google.android.webview/org.chromium.content.app.SandboxedProcessService0}

                } else if(TextUtils.equals("startService", methodName)){
                    Intent intent = (Intent) args[1];
                    ComponentName componentName = intent.getComponent();
                    System.out.println("methodName=  startService" + componentName.toString() + "  pid= " + Process.myPid());
                } else if(TextUtils.equals("serviceDoneExecuting", methodName)){
                    System.out.println("methodName=  serviceDoneExecuting");
                } else if(TextUtils.equals("unbindService", methodName)){
                    Object obj = args[0];
                    System.out.println("methodName=  unBindService=  objStr=" + obj.toString() + " hashCode=" + obj.hashCode());
                    ...
                    System.out.println(crashInfo.exceptionMessage);
                }
